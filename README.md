...
## Note:
I did redo the applicatoin side of this project. Not the ML side since I'm yet to find a large enough dataset for song lyrics that's annotated "correctly" enough for my use case of chunked attention learning for a more advanced model. Check out the frontend [https://luminary.angelv.dev/](https://luminary.angelv.dev/)!
